                ...
                <div className="App" onMouseDown={this.onClick} onTouchStart={this.onClick} data-target="app">
                    ...
                    <header className="App-header" data-target="header">
                        ...
                        <svg data-target="svg" viewBox="0 0 88 107.28203230275507" style={{width: "200px"}}>
                            <path data-target="path1" d="M 74 53.64101615137753 L 14.000000000000027 88.28203230275507 L 14 19 L 74 53.64101615137753 Z" fill="#333" stroke-linejoin="round" stroke-width="8" opacity="1" stroke="#333" origin="50% 50%" />
