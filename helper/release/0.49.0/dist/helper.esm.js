...
version: 0.1.3
*/
import { deepFlat, find, isArray } from '@daybrush/utils';
...
function (_super) {
  ...
  var __proto = ArrayChild.prototype;
  ...
  __proto.getSingleChild = function () {
    var _a;

    var groupElement = this.groupElement;

    if (groupElement) {
      var singleChild = (_a = this.parent) === null || _a === void 0 ? void 0 : _a.value.find(function (t) {
        return t.value === groupElement;
      });
  ...
  __proto.add = function (targets) {
    ...
    value.forEach(function (child) {
      ...
      var groupChild = value.find(function (child2) {
        ...
        var firstElement = __spreadArray([], child2.map.keys(), true)[0];
...
function (_super) {
  ...
  __proto.findChild = function (element, isAuto) {
...
export { ArrayChild, Child, GroupManager, SingleChild, toTargetList };
