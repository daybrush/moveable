...
(function (global, factory) {
    ...
    */
    ...
    var t$1,r$2,u$2=[],i$2=n.__r;n.__r=function(n){i$2&&i$2(n),t$1=0,(r$2=n.__c).__H&&(r$2.__H.t=A$2(r$2.__H.t));};var f$2=n.diffed;n.diffed=function(n){f$2&&f$2(n);var t=n.__c;if(t){var r=t.__H;r&&(r.u=(r.u.some(function(n){n.ref&&(n.ref.current=n.createHandle());}),[]),r.i=A$2(r.i));}};var o$2=n.unmount;function e$1(t){n.__h&&n.__h(r$2);var u=r$2.__H||(r$2.__H={o:[],t:[],i:[],u:[]});return t>=u.o.length&&u.o.push({}),u.o[t]}function c$2(n){return a$1(q$1,n)}function a$1(n,u,i){var f=e$1(t$1++);return f.__c||(f.__c=r$2,f.v=[i?i(u):q$1(void 0,u),function(t){var r=n(f.v[0],t);f.v[0]!==r&&(f.v[0]=r,f.__c.setState({}));}]),f.v}function v$1(n,u){var i=e$1(t$1++);h$1(i.m,u)&&(i.v=n,i.m=u,r$2.__H.t.push(i),T$1(r$2));}function m$1(n,u){var i=e$1(t$1++);h$1(i.m,u)&&(i.v=n,i.m=u,r$2.__H.i.push(i));}function d$1(n){return l(function(){return {current:n}},[])}function p$1(n,u,i){var f=e$1(t$1++);h$1(f.m,i)&&(f.m=i,r$2.__H.u.push({ref:n,createHandle:u}));}function l(n,r){var u=e$1(t$1++);return h$1(u.m,r)?(u.m=r,u.p=n,u.v=n()):u.v}function s$1(n,t){return l(function(){return n},t)}function y$1(n){var u=r$2.context[n.__c];if(!u)return n.__p;var i=e$1(t$1++);return null==i.v&&(i.v=!0,u.sub(r$2)),u.props.value}function _$3(t,r){n.useDebugValue&&n.useDebugValue(r?r(t):t);}n.unmount=function(n){o$2&&o$2(n);var t=n.__c;if(t){var r=t.__H;r&&r.o.forEach(function(n){return n.l&&n.l()});}};var T$1=function(){};function g$2(){u$2.some(function(n){n.s=!1,n.__P&&(n.__H.t=A$2(n.__H.t));}),u$2=[];}if("undefined"!=typeof window){var w$1=n.requestAnimationFrame;T$1=function(t){(!t.s&&(t.s=!0)&&1===u$2.push(t)||w$1!==n.requestAnimationFrame)&&(w$1=n.requestAnimationFrame,(n.requestAnimationFrame||function(n){var t=function(){clearTimeout(r),cancelAnimationFrame(u),setTimeout(n);},r=setTimeout(t,100),u=requestAnimationFrame(t);})(g$2));};}function A$2(n){return n.forEach(E$1),n.forEach(F$1),[]}function E$1(n){n.l&&n.l();}function F$1(n){var t=n.v();"function"==typeof t&&(n.l=t);}function h$1(n,t){return !n||t.some(function(t,r){return t!==n[r]})}function q$1(n,t){return "function"==typeof t?t(n):t}
    ...
    */
    ...
    var t$2,r$3,u$3=[],i$3=n.__r;n.__r=function(n){i$3&&i$3(n),t$2=0,(r$3=n.__c).__H&&(r$3.__H.t=A$3(r$3.__H.t));};var f$3=n.diffed;n.diffed=function(n){f$3&&f$3(n);var t=n.__c;if(t){var r=t.__H;r&&(r.u=(r.u.some(function(n){n.ref&&(n.ref.current=n.createHandle());}),[]),r.i=A$3(r.i));}};var o$3=n.unmount;function e$2(t){n.__h&&n.__h(r$3);var u=r$3.__H||(r$3.__H={o:[],t:[],i:[],u:[]});return t>=u.o.length&&u.o.push({}),u.o[t]}function c$3(n){return a$2(q$2,n)}function a$2(n,u,i){var f=e$2(t$2++);return f.__c||(f.__c=r$3,f.v=[i?i(u):q$2(void 0,u),function(t){var r=n(f.v[0],t);f.v[0]!==r&&(f.v[0]=r,f.__c.setState({}));}]),f.v}function v$2(n,u){var i=e$2(t$2++);h$2(i.m,u)&&(i.v=n,i.m=u,r$3.__H.t.push(i),T$2(r$3));}function m$2(n,u){var i=e$2(t$2++);h$2(i.m,u)&&(i.v=n,i.m=u,r$3.__H.i.push(i));}function d$2(n){return l$1(function(){return {current:n}},[])}function p$2(n,u,i){var f=e$2(t$2++);h$2(f.m,i)&&(f.m=i,r$3.__H.u.push({ref:n,createHandle:u}));}function l$1(n,r){var u=e$2(t$2++);return h$2(u.m,r)?(u.m=r,u.p=n,u.v=n()):u.v}function s$2(n,t){return l$1(function(){return n},t)}function y$2(n){var u=r$3.context[n.__c];if(!u)return n.__p;var i=e$2(t$2++);return null==i.v&&(i.v=!0,u.sub(r$3)),u.props.value}function _$4(t,r){n.useDebugValue&&n.useDebugValue(r?r(t):t);}n.unmount=function(n){o$3&&o$3(n);var t=n.__c;if(t){var r=t.__H;r&&r.o.forEach(function(n){return n.l&&n.l()});}};var T$2=function(){};function g$3(){u$3.some(function(n){n.s=!1,n.__P&&(n.__H.t=A$3(n.__H.t));}),u$3=[];}if("undefined"!=typeof window){var w$2=n.requestAnimationFrame;T$2=function(t){(!t.s&&(t.s=!0)&&1===u$3.push(t)||w$2!==n.requestAnimationFrame)&&(w$2=n.requestAnimationFrame,(n.requestAnimationFrame||function(n){var t=function(){clearTimeout(r),cancelAnimationFrame(u),setTimeout(n);},r=setTimeout(t,100),u=requestAnimationFrame(t);})(g$3));};}function A$3(n){return n.forEach(E$2),n.forEach(F$2),[]}function E$2(n){n.l&&n.l();}function F$2(n){var t=n.v();"function"==typeof t&&(n.l=t);}function h$2(n,t){return !n||t.some(function(t,r){return t!==n[r]})}function q$2(n,t){return "function"==typeof t?t(n):t}
    ...
    function (_super) {
      ...
      __proto.render = function () {
        ...
        if (isGroup) {
          ...
          return S$2(MoveableGroup, __assign$3({
            key: "group",
            ref: ref(this, "moveable")
          }, nextProps));
        } else {
          var moveableTarget = isArr ? target[0] : target;
          return S$2(MoveableManager, __assign$3({
            key: "single",
            ref: ref(this, "moveable")
