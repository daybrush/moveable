...
function (_super) {
  ...
  __proto.updateTargetRect = function (target, nextState) {
    ...
    var beforeMatrix = nextState.beforeMatrix,
        _a = nextState.left,
        left = _a === void 0 ? state.left : _a,
        _b = nextState.top,
        top = _b === void 0 ? state.top : _b,
        _c = nextState.width,
        width = _c === void 0 ? state.width : _c,
        _d = nextState.height,
        height = _d === void 0 ? state.height : _d,
        _e = nextState.transformOrigin,
        transformOrigin = _e === void 0 ? state.transformOrigin : _e,
        _f = nextState.origin,
        originalOrigin = _f === void 0 ? state.origin : _f;
    var nextTransform = getTransform(target, true);

    var _g = caculatePosition(multiple3x2(beforeMatrix.slice(), nextTransform), transformOrigin, width, height),
        origin = _g[0],
        pos1 = _g[1],
        pos2 = _g[2],
        pos3 = _g[3],
    ...
    var _h = getRotationInfo(origin, pos1, pos2),
        direction = _h[0],
        rotationRad = _h[1],
        rotationPos = _h[2];
