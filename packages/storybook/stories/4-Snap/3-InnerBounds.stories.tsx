...
import "../index.css";
import { INNER_BOUNDS_DRAGGABLE_TEMPLATE_OPTIONS } from "../../template/snap/ables/Draggable.template";
import { INNER_BOUNDS_PROPS_TEMPLATE } from "../../template/basic/ables/Snappable.template";
...
story.add("Inner Bounds Area", () => {
    return <DraggableApp
        children={NESTED_JSX}
        description={<p className="description">You can only move the target within the inner bounds area with Draggable, Resizable, Rotatable, Warpable, Scalable. (
    ...
    preview: previewCollection(
        ...
        NESTED_CSS_TEMPLATE,
        BASIC_VANILLA_TEMPLATE(INNER_BOUNDS_DRAGGABLE_TEMPLATE_OPTIONS),
        BASIC_REACT_TEMPLATE(NESTED_REACT_MARKUP_TEMPLATE, INNER_BOUNDS_DRAGGABLE_TEMPLATE_OPTIONS),
        BASIC_ANGULAR_HTML_TEMPLATE(NESTED_ANGULAR_MARKUP_TEMPLATE, INNER_BOUNDS_DRAGGABLE_TEMPLATE_OPTIONS),
        BASIC_ANGULAR_COMPONENT_TEMPLATE(INNER_BOUNDS_DRAGGABLE_TEMPLATE_OPTIONS),
        BASIC_SVELTE_TEMPLATE(INNER_BOUNDS_DRAGGABLE_TEMPLATE_OPTIONS),
        BASIC_SVELTE_JSX_TEMPLATE(NESTED_SVELTE_MARKUP_TEMPLATE, INNER_BOUNDS_DRAGGABLE_TEMPLATE_OPTIONS),
        DRAGGABLE_FRAME,
    ),
});
