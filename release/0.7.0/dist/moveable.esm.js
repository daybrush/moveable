...
import { isArray, isUndefined, hasClass, dot, splitUnit, isObject, splitBracket, camelize } from '@daybrush/utils';
...
var Rotatable = {
  ...
  dragGroupControlStart: function (moveable, e) {
    ...
    triggerChildAble(moveable, this, "dragControlStart", __assign$2({}, e, {
      parentRotate: 0
...
var Resizable = {
  ...
  dragGroupControlStart: function (moveable, e) {
    ...
    var _a = moveable.state,
        parentLeft = _a.left,
        parentTop = _a.top;
    var enabledEvents = triggerChildAble(moveable, this, "dragControlStart", __assign$2({}, e, {
      parentRotate: 0
    }), function (child, childDatas) {
      var _a = child.state,
          left = _a.left,
...
function (_super) {
  ...
  __proto.render = function () {
    ...
    if (isGroup) {
      return index.createElement(MoveableGroup, __assign$2({
        key: "group",
      ...
      return index.createElement(MoveableManager, __assign$2({
        key: "single",
        ref: ref(this, "moveable")
      }, __assign$2({}, this.props, {
  ...
  Moveable.defaultProps = __assign$2({}, MoveableManager.defaultProps, {
    ables: MOVEABLE_ABLES
  });
  return Moveable;
}(index.PureComponent);
